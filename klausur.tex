\documentclass[a4paper,11pt, headsepline,headinclude, pagenumber=no]{scrreprt}

% pagenumber=no => keine Seitenzahl in der Fußzeile - wir haben ja eine in der Kopfzeile
